...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String fileSynsets = "./data/wordnet/synsets.txt";
        String fileHyponyms = "./data/wordnet/hyponyms.txt";
        WordNet wn = new WordNet(fileSynsets, fileHyponyms);
        NGramMap ngMap = new NGramMap(WORDS_FILE, TOTAL_COUNTS_FILE);

        hns.startUp();
        hns.register("history", new DummyHistoryHandler());
        hns.register("historytext", new DummyHistoryTextHandler());
        hns.register("hyponyms", new HyponymsHandler(wn, ngMap));
